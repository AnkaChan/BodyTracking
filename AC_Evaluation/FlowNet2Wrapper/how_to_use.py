...
def main():
    ...
    # im1 = cv2.imread(r'/media/anka/Data/OpticalFlow/MPI-Sintel-complete/test/clean/ambush_1/frame_0001.png')
    # im2 = cv2.imread(r"/media/anka/Data/OpticalFlow/MPI-Sintel-complete/test/clean/ambush_1/frame_0002.png")

    im1 = cv2.imread(r'/media/Data001/MocapProj/2020_08_24_TexturedFitting_Lada_Rendering/HandOnGround/A/FlipComparison/A08564.0Rendered.png')
    im2 = cv2.imread(r"/media/Data001/MocapProj/2020_08_24_TexturedFitting_Lada_Rendering/HandOnGround/A/FlipComparison/A08564.png.png")
