...
if __name__ == '__main__':
    ...
    inputs.finalMeshFolder = r'F:\WorkingCopy2\2020_07_28_TexturedFitting_Lada\Final\Mesh'
    ...
    inputs.outFolder = r'X:\MocapProj\2020_08_24_TexturedFitting_Lada_Rendering\Evaluation_Silhouette'
    ...
    outFolderFinal = join(inputs.outFolder, 'Final', )
    outFolderFinalMeshes = join(inputs.outFolder, 'Final', 'Meshes')
    outFolderFinalImgs = join(inputs.outFolder, 'Final', 'Rendered')
    renderConsecutiveFrames(inputs.finalMeshFolder, inputs.cleanPlateFolder, inputs.texturedMesh, inputs.camParamF,
                            outFolderFinalImgs, frameNames=frameNames, cfg=cfg, inMeshExt='ply', convertToM=False,
                            rendererType='Silhouette')
    ...
    #
    # renderConsecutiveFrames(outFolderLBSMeshes, inputs.cleanPlateFolder, inputs.texturedMesh, inputs.camParamF,
    #     outFolderLBSImgs, frameNames=frameNames, cfg=cfg, inMeshExt='obj', convertToM=True, rendererType='Silhouette')
    #
    # # # Copy meshes generate by only lbs fitting and render it
    ...
    #
    # renderConsecutiveFrames(outFolderInterpolatedMeshes, inputs.cleanPlateFolder, inputs.texturedMesh, inputs.camParamF,
    #     outFolderInterpolatedImgs, frameNames=frameNames, cfg=cfg, inMeshExt='obj', convertToM=True, rendererType='Silhouette')