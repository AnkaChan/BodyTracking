...
if __name__ == '__main__':
    ...
    deformedVerts = smplsh(beta, pose, trans,)
    T = smplsh.getTransformation(beta, pose, trans)
    ...
    v_shaped = torch.tensordot(smplsh.shapedirs, beta, dims=([2], [0])) + smplsh.v_template
    personalShapeFinal = personalShapeFinalRestpose - v_shaped.cpu().detach().numpy()
